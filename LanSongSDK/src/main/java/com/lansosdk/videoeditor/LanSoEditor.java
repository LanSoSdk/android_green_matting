...
public class LanSoEditor {
    ...
    public static void initSDK(Context ctx, String string){
        context=ctx;
    ...
    private static void printSDKVersion(Context ctx)
    {
        ...
        String nativeVersion="* \t version:"+ VERSION + "; Limited time: year:"+ LanSoEditor.getLimitYear()+ " month:" + LanSoEditor.getLimitMonth();
    ...
    private static void initSo(Context context, String str) {
        ...
        LanSoEditorBox.init(context,str);
    }
